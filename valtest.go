	...
	testRequests := []testRequest{
		{
			"valid GET request",
			"GET",
			"/v0/foo/aba?fod=false",
			"",
			nil,
		},
		{
			"valid GET request with query param bip",
			"GET",
			"/v0/foo/aab?bip=38&fod=false",
			"",
			nil,
		},
		{
			...
			"GET",
			"/v0/foo/aaad?fod=false",
			"",
			nil,
		},
		{
			"invalid GET request: query param bip empty, query param fod invalid",
			"GET",
			"/v0/foo/aba?bip=&fod=argh",
			"",
			nil,
		},
		{
			"invalid GET request: query param bip not integer, fod missing",
			"GET",
			"/v0/foo/aba?bip=4x",
			"",
			nil,
		...
		{
			"invalid GET request: query param bip below minimum",
			"GET",
			"/v0/foo/aba?bip=0&fod=t",
			"",
			nil,
		},
		{
			...
			"GET",
			"/v0/foo/aba?bip=-4294967296.54&fod=1",
			"",
			nil,
		},
		{
